...
public class HeartSoundsActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_display.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                Intent myIntent = new Intent(HeartSoundsActivity.this, RecordShow.class);
                myIntent.putExtra("files",filesToLoad);
                HeartSoundsActivity.this.startActivity(myIntent);
            }
        });

        btn_record_new.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent myIntent = new Intent(HeartSoundsActivity.this, RecordNew.class);
                HeartSoundsActivity.this.startActivity(myIntent);
            }
        });
