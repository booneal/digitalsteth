...
public class LungsSoundActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_display.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                Intent myIntent = new Intent(LungsSoundActivity.this, RecordShow.class);
                myIntent.putExtra("files",filesToLoad);
                LungsSoundActivity.this.startActivity(myIntent);
            }
        });

        btn_record_new.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent myIntent = new Intent(LungsSoundActivity.this, RecordNew.class);
                LungsSoundActivity.this.startActivity(myIntent);
            }
        });
